...
(function() {
  var BALL_R, Bar, Fmt442, Foo, GOAL_WIDTH, HALF_GOAL_WIDTH, MAX_DASH_FORCE, MAX_KICK_FORCE, OP_GOAL_POS, PENALTY_AREA_LENGTH, PENALTY_AREA_WIDTH, PITCH_HALF_LENGTH, PITCH_HALF_WIDTH, PITCH_LENGTH, PLAYER_R, TBots, Vector2d, in_my_penalty, is_goalie, mY_GOAL_POS, multiply, player_near_ball, root;
  ...
  TBots = (function() {
    function TBots(num, side) {
      this.teamname = 'TBots';
      this.fill_color = '#000099';
      this.teamnum = num;
      this.side = side;
      this.fmt = new Fmt442();
      this.eps = Math.PI / 6;
    ...
    TBots.prototype.getfmtpos = function(bp) {
      var pos;
      pos = this.fmt.p[this.teamnum];
      if (this.teamnum !== 0) {
        pos.x = (PITCH_HALF_LENGTH + bp[0]) * pos.ratio - PITCH_HALF_LENGTH;
    ...
    TBots.prototype.think = function(wm) {
      this.wm = wm;
      if (this.side === 'left') {
        this.teammates = this.wm.leftplayers;
      } else {
    ...
    TBots.prototype.playon = function() {
      if (is_goalie(this.teamnum)) {
        return this.goalie();
      }
      return this.play();
    ...
    TBots.prototype.goalkick = function() {
      return this.play();
    };

    TBots.prototype.goalie = function() {
      var ret;
      if (Vector2d.distance(this.mypos, this.wm.ball) < HALF_GOAL_WIDTH && in_my_penalty(this.wm.ball)) {
        ret = this.goto(this.wm.ball);
        ret.suck = 0;
    ...
    TBots.prototype.goto = function(pos) {
      var angle, delta, me2pos;
      if (Vector2d.distance(pos, this.mypos) < 0.1) {
        return {};
      }
    ...
    TBots.prototype.go_and_kick = function(ball) {
      var angleb2g, anglem2b, ball2goal, delta1, delta2, dis, goal2ball, gopos, me2ball, unit;
      goal2ball = Vector2d.subtract(ball, OP_GOAL_POS);
      unit = Vector2d.unit(goal2ball);
      gopos = Vector2d.add(Vector2d.multiply(unit, BALL_R + PLAYER_R + 2), ball);
